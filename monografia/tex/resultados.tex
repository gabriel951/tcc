...
% atribute list to check - derived
% 10. credit rate acc
% 11. in condition
% 12. drop rate
% 13. fail rate
...
%    6:00 - 7:00 & Livre \\
%    \hline
%    \parbox[c]{1cm}{\includegraphics[width=4cm]{sex.png}}
%    & 
%    oi \\
%    \hline
%\end{tabular}
%\end{center}
%\caption{Tabela Comparativa entre Histogramas}
%\end{table}
...
%    \centering
%    \includegraphics[width = 10cm]{all_students/local.png}
%    \label{atr_res}
%\end{figure}
%\clearpage
